...
JAKA_JOINT_FRICTIONLOSS = {
    joint_name: 0.01 for joint_name in JAKA_JOINT_NAMES
}
...
JAKA_CFG = RobotCfg(
    ...
    joint_pos_lower_limit=JAKA_JOINT_POS_LOWER_LIMIT,
    joint_pos_upper_limit=JAKA_JOINT_POS_UPPER_LIMIT,
    joint_velocity_limit=JAKA_JOINT_VELOCITY_LIMIT,
    joint_effort_limit=JAKA_JOINT_EFFORT_LIMIT,
    joint_armature=JAKA_JOINT_ARMATURE,
    joint_frictionloss=JAKA_JOINT_FRICTIONLOSS,
    mjcf_path="jaka_data/Khan_mini_simplified/Khan_mini_simplified_new_bigfeet.xml",
    default_qpos=JAKA_DEFAULT_QPOS,
    publish_hz=50.0,
    domain_id=0,
    interface="eth0",
    mocap_ip="localhost",
